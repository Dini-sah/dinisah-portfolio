...
import MaskedRotatingText from "../../components/effects/MaskedRotatingText";
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium dark:text-[#e4ded7] text-zinc-800 md:text-[20px] lg:text-left">
            ...
            <MaskedRotatingText
              ...
              className="inline-flex min-w-[112px] items-center justify-center overflow-hidden text-left text-[#e5484d] dark:text-primary-color sm:min-w-[132px] lg:justify-start"
              interval={3200}
            />
            {/* <RotatingText
              texts={statusMessages}
